...
function createClient(params) {
  ...
  const userAgentHeader = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["getUserAgentHeader"])(`contentful.js/${"8.5.8"}`, config.application, config.integration);
